...
etl_connector.py: The Main ETL script.<br>
...
ENV_TEMPLATE: Provides a template of .env file.
...
4. Set up the .env file: Create a file named .env in the project root with the following content: <br>
    &nbsp; &nbsp;&nbsp;&nbsp;X-OTX-API-KEY=<your_alienvault_otx_api_key> <br>
    &nbsp; &nbsp;&nbsp;&nbsp;API_BASE_URL=https://otx.alienvault.com/api/v1/ <br>
